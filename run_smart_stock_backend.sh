...
echo "${YELLOW}nohup $pythonPath $jobDir/$jobName  --host 0.0.0.0 --port 38888 > logs/${logName}.log 2>&1 &${NOCOLOR}"
nohup $pythonPath $jobDir/$jobName  --host 0.0.0.0 --port 38888 > logs/${logName}.log 2>&1 &
